        ...
        <div id="tabcon">
            <div class="box show">
                <form action="user.do" method="post" id="loginForm">
                    ...
                    <input type="text" class="user yahei16" id="userName" name="userName" value="${resultInfo.rsObj.uname}" /><br /><br />
                    <input type="password" class="pwd yahei16" id="userPwd" name="userPwd" value="${resultInfo.rsObj.upwd}" /><br /><br />
                    <input name="rem" type="checkbox" value="1"  class="inputcheckbox"/> <label>记住我</label>&nbsp; &nbsp;
                    <span id="msgSpan" style="color: red;font-size: 12px;">${resultInfo.msg}</span><br /><br />
...
<div id="bottom">
    <div id="copyright">
        ...
        <div class="text">
            Copyright © 2006-2026  <a href="http://www.shsxt.com">CS_loda.etc</a>  All Rights Reserved
        </div>
    </div>
</div>
</body>
