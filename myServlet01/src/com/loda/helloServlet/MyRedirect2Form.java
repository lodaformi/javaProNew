 ...
 * @Version 1.0
 */
@WebServlet(value = "/myRedForm")
public class MyRedirect2Form extends HttpServlet {
    @Override
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("Hello Servlet myRedirect2form!");
//        resp.getWriter().write("Hello World myRedirect");
//        resp.sendRedirect("index.jsp");
        resp.sendRedirect("Myform01.html");
        ...
        System.out.println("uname value: " + pwd);

        // 获取指定名称参数的所有参数值，返回数组
        String[] citys = req.getParameterValues("city");
        System.out.println("hobby value: " + Arrays.toString(citys));
        ...
        System.out.println("hobby value: " + Arrays.toString(sex));


        // 获取指定名称参数的所有参数值，返回数组
        String[] switch2 = req.getParameterValues("switch");
        System.out.println("hobby value: " + Arrays.toString(switch2));

        // 获取指定名称参数的所有参数值，返回数组
        String[] desc = req.getParameterValues("desc");
        System.out.println("hobby value: " + Arrays.toString(desc));
    }
}
